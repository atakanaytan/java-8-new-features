...
public class StudentDatabase {
    ...
    public static Optional<Student> getOptionalStudent() {
        ...
        Bike bike = new Bike("Client34", "Client34");
    ...
    public static List<Student> getAllStudents() {
         ...
         * 2nd grade students
         */
        Student student1 = new Student("Adam", 3, 3.6, "male", 10, Arrays.asList("swimming", "basketball", "volleyball"));
        Student student2 = new Student("Jenny", 3, 3.8, "female", 11, Arrays.asList("swimming", "gymnastics", "soccer"));
        /**
         * 3rd grade students
         */
         ...
         * 4th grade students
         */
        Student student5 = new Student("Sophia", 2, 3.3, "female", 10, Arrays.asList("swimming", "dancing", "football"));
