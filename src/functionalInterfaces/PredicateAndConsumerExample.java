...
public class PredicateAndConsumerExample {
    ...
    Predicate<Student> gradeLevelHigherOrEqual3 = (s) -> s.getGradeLevel() >= 3;
    Predicate<Student> gpaHigherOrEqual3_9 = (s) -> s.getGpa() >= 3.9;
    ...
    Consumer<Student> studentConsumer = (student -> {
        ...
        /*
        if (gradeLevelHigherOrEqual3.and(gpaHigherOrEqual3_9).test(student)) {
